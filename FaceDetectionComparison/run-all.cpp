...
#pragma comment(lib,"lib/dlib19.16.0_release_64bit_msvc1925.lib")
...
{
	faceCascadePath = "../model/haarcascade_frontalface_default.xml";
	...
	String mmodModelPath = "../model/mmod_human_face_detector.dat";
